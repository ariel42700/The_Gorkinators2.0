...
p <- plot_ly(data = annual_data, x = ~Year) %>%
    ...
    add_lines(y = ~Avg_Mortgage_Rate, name = 'Mortgage Rate', yaxis = 'y2', line = list(color = 'red'), legendgroup = 'mortgage', linetype = I('dash'),
    ...
    add_lines(y = ~Avg_Auto_Loan_Rate, name = 'Auto Loan Rate', yaxis = 'y2', line = list(color = 'orange'), legendgroup = 'auto', linetype = I('dash'),
    ...
    add_lines(y = ~Avg_CC_Rate, name = 'Credit Card Rate', yaxis = 'y2', line = list(color = 'magenta'), legendgroup = 'creditcard', linetype = I('dash'),
    ...
    add_lines(y = ~Avg_Student_Loan_Rate, name = 'Student Loan Rate', yaxis = 'y2', line = list(color = 'gray'), legendgroup = 'studentloan', linetype = I('dash'),
    ...
    layout(
        ...
        yaxis = list(title = 'Loan Amount (Trillions of $)', side = 'left'),
